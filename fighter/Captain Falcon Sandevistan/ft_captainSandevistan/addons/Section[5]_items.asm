...
######### SILOUHETTE
#===============================================
custom_SiloCustomizerEntry:
        .4byte 0x00000000
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32("ft_captain", 5, "custom_SiloCustomizer")]
custom_SiloCustomizer:
        .4byte 0x00000000         [R_PPC_ADDR32("ft_captain", 5, "custom_SiloCustomizer_1")]
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32("ft_captain", 5, "custom_SiloCustomizer_1")]
        .4byte 0x00000000
        ...
        .4byte 0x00000000         [R_PPC_ADDR32("ft_captain", 1, "custom_SiloCustomizer__onNotifyEventChangeStatus")]
...
custom_SiloCustomizer_1:
        .string "itCustomSiloCustomizer"
        .balign 4
custom_SiloCustomizer_2:
        ...
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32("ft_captain", 5, "custom_SiloCustomizer_6")]
        .4byte 0x00000000
        .4byte 0x00000000
        .4byte 0x00000000
custom_SiloCustomizer_3:
        .4byte 0x00000000         [R_PPC_ADDR32("ft_captain", 5, "custom_SiloCustomizer_1")]
        .4byte 0x00000000         [R_PPC_ADDR32("ft_captain", 5, "custom_SiloCustomizer_2")]
custom_SiloCustomizer_4:
        .string "itCustomizer<itCustomSiloCustomizer>"
        .balign 4
custom_SiloCustomizer_5:
        .4byte 0x00000000         [R_PPC_ADDR32("sora_melee", 5, "loc_7C8")]
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32("sora_melee", 5, "loc_54740")]
        .4byte 0x00000000
        ...
        .4byte 0x00000000
        .4byte 0x00000000
custom_SiloCustomizer_6:
        .4byte 0x00000000         [R_PPC_ADDR32("ft_captain", 5, "custom_SiloCustomizer_4")]
        .4byte 0x00000000         [R_PPC_ADDR32("ft_captain", 5, "custom_SiloCustomizer_5")]