...
######### WITCH TIME
#===============================================
custom_WitchTimeCustomizerEntry:
        .4byte 0x00000000
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32("ft_samus", 5, "custom_WitchTimeCustomizer")]
custom_WitchTimeCustomizer:
        .4byte 0x00000000         [R_PPC_ADDR32("ft_samus", 5, "custom_WitchTimeCustomizer_1")]
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32("ft_samus", 5, "custom_WitchTimeCustomizer_1")]
        .4byte 0x00000000
        ...
        .4byte 0x00000000         [R_PPC_ADDR32("ft_samus", 1, "custom_WitchTimeCustomizer__onConstruct")]
        .4byte 0x00000000         [R_PPC_ADDR32("ft_samus", 1, "custom_WitchTimeCustomizer__onDestruct")]
...
custom_WitchTimeCustomizer_1:
        .string "itCustomWitchTimeCustomizer"
        .balign 4
custom_WitchTimeCustomizer_2:
        ...
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32("ft_samus", 5, "custom_WitchTimeCustomizer_6")]
        .4byte 0x00000000
        .4byte 0x00000000
        .4byte 0x00000000
custom_WitchTimeCustomizer_3:
        .4byte 0x00000000         [R_PPC_ADDR32("ft_samus", 5, "custom_WitchTimeCustomizer_1")]
        .4byte 0x00000000         [R_PPC_ADDR32("ft_samus", 5, "custom_WitchTimeCustomizer_2")]
custom_WitchTimeCustomizer_4:
        .string "itCustomizer<itCustomWitchTimeCustomizer>"
        .balign 4
custom_WitchTimeCustomizer_5:
        .4byte 0x00000000         [R_PPC_ADDR32("sora_melee", 5, "loc_7C8")]
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32("sora_melee", 5, "loc_54740")]
        .4byte 0x00000000
        ...
        .4byte 0x00000000
        .4byte 0x00000000
custom_WitchTimeCustomizer_6:
        .4byte 0x00000000         [R_PPC_ADDR32("ft_samus", 5, "custom_WitchTimeCustomizer_4")]
        .4byte 0x00000000         [R_PPC_ADDR32("ft_samus", 5, "custom_WitchTimeCustomizer_5")]