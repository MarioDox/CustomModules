...
Enemy____ct:
    ...
    /* XXXXXXXX: */    lis r3,0x0                               [R_PPC_ADDR16_HA(41, 4, "custom_emSlowModuleImpl_Entry")]
    /* XXXXXXXX: */    addi r3,r3,0x0                           [R_PPC_ADDR16_LO(41, 4, "custom_emSlowModuleImpl_Entry")]
    ...
    /* XXXXXXXX: */    mr r7,r28            # r7,r29 (0x0) > r7,r28 (0x1, both registers used for bits throughout func), it's the hitSFX flag, fixes custom hit sfx code to work with SSE enemies
    /* 00000F60: */    mr r8,r29
