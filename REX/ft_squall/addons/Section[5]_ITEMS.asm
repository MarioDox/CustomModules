custom_ORBCustomizerEntry:
        .4byte 0x00000000
        .4byte 0x00000000
        .4byte 0x00000000       [R_PPC_ADDR32("ft_mario", 5, "custom_ORBCustomizer")]
custom_ORBCustomizer:
        .4byte 0x00000000         [R_PPC_ADDR32("ft_mario", 5, "custom_ORBCustomizer_1")]
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32("ft_mario", 5, "custom_ORBCustomizer_1")]
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32("sora_melee", 1, "soNullable__isNull")]
        .4byte 0x00000000         [R_PPC_ADDR32("sora_melee", 1, "itMetroidCustomizer____dt")]
        ...
        .4byte 0x00000000         [R_PPC_ADDR32("ft_mario", 1, "custom_ORBCustomizer__onNotifyEventCollisionSearch")]
        .4byte 0x00000000         [R_PPC_ADDR32("ft_mario", 1, "custom_ORBCustomizer__onNotifyEventCollisionSearchCheck")]
...
custom_ORBCustomizer_1:
        .string "itSquallOrbCustomizer"
        .balign 4
custom_ORBCustomizer_2:
        ...
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32("ft_mario", 5, "custom_ORBCustomizer_6")]
        .4byte 0x00000000
        .4byte 0x00000000
        .4byte 0x00000000
custom_ORBCustomizer_3:
        .4byte 0x00000000         [R_PPC_ADDR32("ft_mario", 5, "custom_ORBCustomizer_1")]
        .4byte 0x00000000         [R_PPC_ADDR32("ft_mario", 5, "custom_ORBCustomizer_2")]
custom_ORBCustomizer_4:
        .string "itCustomizer<itSquallOrbCustomizer>"
custom_ORBCustomizer_5:
        .4byte 0x00000000         [R_PPC_ADDR32("sora_melee", 5, "loc_7C8")]
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32("sora_melee", 5, "loc_54740")]
        .4byte 0x00000000
        ...
        .4byte 0x00000000
        .4byte 0x00000000
custom_ORBCustomizer_6:
        .4byte 0x00000000         [R_PPC_ADDR32("ft_mario", 5, "custom_ORBCustomizer_4")]
        .4byte 0x00000000         [R_PPC_ADDR32("ft_mario", 5, "custom_ORBCustomizer_5")]